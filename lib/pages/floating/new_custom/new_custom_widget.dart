...
class _NewCustomWidgetState extends State<NewCustomWidget> {
  ...
  void initState() {
    ...
    _model.customTFTextController ??= TextEditingController();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Container(
                    width: 280.0,
                    child: TextFormField(
                      controller: _model.customTFTextController,
                      ...
                      validator: _model.customTFTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                            ...
                            child: SureQueryWidget(
                              saveChangesP: () async {
                                await CustomsTable().insert({
                                  'custom': _model.customTFTextController.text,
                                });
                              },
                            ),
                          );
