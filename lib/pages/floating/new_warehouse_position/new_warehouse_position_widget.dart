...
class _NewWarehousePositionWidgetState
  ...
  void initState() {
    ...
    _model.warehousePositionTFTextController ??= TextEditingController();
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  width: 280.0,
                  child: TextFormField(
                    controller: _model.warehousePositionTFTextController,
                    ...
                    validator: _model.warehousePositionTFTextControllerValidator
                        .asValidator(context),
                  ),
                ),
              ),
              Builder(
                builder: (context) => InkWell(
                  ...
                  onTap: () async {
                    if (_model.warehousePositionTFTextController.text != '') {
                      await showDialog(
                        context: context,
                            ...
                            child: SureQueryWidget(
                              saveChangesP: () async {
                                await WarehousePositionsTable().insert({
                                  ...
                                  'position': _model
                                      .warehousePositionTFTextController.text,
                                });
                              },
                            ),
                          );
